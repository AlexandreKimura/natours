...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxleGFuZHJlbWtpbXVyYSIsImEiOiJja3NsYnozYncxOWk5MnZwYzk2bWdvNzJ5In0.gN75apmBc4RMJ77gF5slLA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/alexandremkimura/cl72n5l8a001q15qpv6hluszm',
    // style URL
    scrollZoom: false
  });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? "http://localhost:3333/api/v1/users/updateMyPassword" : "http://localhost:3333/api/v1/users/updateMe";
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51JF2IPD4rD0axeCFNWLiWJx8b1rN3mmmiRWkc7ADGRbxGRpaP5A51dRRqdQKph3BqDukS6i6n08jqfWNHSZy6p3p001PB8u31E');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3333/api/v1/bookings/checkout-session/".concat(tourId));
